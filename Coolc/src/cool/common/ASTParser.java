...
import cool.parser.Cases;
import cool.parser.Classes;
import cool.parser.Expression;
import cool.parser.Expressions;
import cool.parser.Feature;
import cool.parser.Features;
import cool.parser.Formal;
import cool.parser.Formals;
import cool.parser.assign;
import cool.parser.attr;
import cool.parser.block;
import cool.parser.bool_const;
import cool.parser.branch;
import cool.parser.class_;
import cool.parser.comp;
import cool.parser.cond;
import cool.parser.dispatch;
import cool.parser.divide;
import cool.parser.eq;
import cool.parser.formal;
import cool.parser.int_const;
import cool.parser.isvoid;
import cool.parser.leq;
import cool.parser.let;
import cool.parser.loop;
import cool.parser.lt;
import cool.parser.method;
import cool.parser.mul;
import cool.parser.neg;
import cool.parser.new_;
import cool.parser.no_expr;
import cool.parser.object;
import cool.parser.plus;
import cool.parser.program;
import cool.parser.static_dispatch;
import cool.parser.string_const;
import cool.parser.sub;
import cool.parser.typcase;
...
class CUP$ASTParser$actions
{
	...
	public final java_cup.runtime.Symbol CUP$ASTParser$do_action(
			...
			java.util.Stack CUP$ASTParser$stack, int CUP$ASTParser$top)
			throws java.lang.Exception
	{
		...
		{
			branch RESULT = null;
			Integer l = (Integer) ((java_cup.runtime.Symbol) CUP$ASTParser$stack
					.elementAt(CUP$ASTParser$top - 4)).value;
			AbstractSymbol n = (AbstractSymbol) ((java_cup.runtime.Symbol) CUP$ASTParser$stack
					.elementAt(CUP$ASTParser$top - 2)).value;
			AbstractSymbol t = (AbstractSymbol) ((java_cup.runtime.Symbol) CUP$ASTParser$stack
					.elementAt(CUP$ASTParser$top - 1)).value;
			Expression e = (Expression) ((java_cup.runtime.Symbol) CUP$ASTParser$stack
					.elementAt(CUP$ASTParser$top - 0)).value;
			curr_lineno = l;
			RESULT = new branch(l.intValue(), n, t, e);
			CUP$ASTParser$result = new java_cup.runtime.Symbol(
		...
		{
			Cases RESULT = null;
			Cases cl = (Cases) ((java_cup.runtime.Symbol) CUP$ASTParser$stack
					.elementAt(CUP$ASTParser$top - 1)).value;
			branch c = (branch) ((java_cup.runtime.Symbol) CUP$ASTParser$stack
					.elementAt(CUP$ASTParser$top - 0)).value;
		...
		case 46: // expr_list ::= expr_list expr
		{
			...
			Expressions el = (Expressions) ((java_cup.runtime.Symbol) CUP$ASTParser$stack
					.elementAt(CUP$ASTParser$top - 1)).value;
			Expression e = (Expression) ((java_cup.runtime.Symbol) CUP$ASTParser$stack
					.elementAt(CUP$ASTParser$top - 0)).value;
		...
		case 44: // actuals ::= LPAREN expr_list RPAREN
		{
			...
			Expressions el = (Expressions) ((java_cup.runtime.Symbol) CUP$ASTParser$stack
					.elementAt(CUP$ASTParser$top - 1)).value;
			RESULT = el;
			CUP$ASTParser$result = new java_cup.runtime.Symbol(12/* actuals */,
					RESULT);
		}
			return CUP$ASTParser$result;
		...
		case 42: // expr_aux ::= LINENO NO_EXPR
		{
			...
			CUP$ASTParser$result = new java_cup.runtime.Symbol(10/* expr_aux */,
					RESULT);
		}
			return CUP$ASTParser$result;
		...
		case 40: // expr_aux ::= LINENO BOOL INT_CONST
		{
			...
			Integer l = (Integer) ((java_cup.runtime.Symbol) CUP$ASTParser$stack
					.elementAt(CUP$ASTParser$top - 2)).value;
			AbstractSymbol b = (AbstractSymbol) ((java_cup.runtime.Symbol) CUP$ASTParser$stack
					.elementAt(CUP$ASTParser$top - 0)).value;
			curr_lineno = l;
			if (b.toString().charAt(0) == '1')
		...
		case 39: // expr_aux ::= LINENO STR STR_CONST
		{
			...
			Integer l = (Integer) ((java_cup.runtime.Symbol) CUP$ASTParser$stack
					.elementAt(CUP$ASTParser$top - 2)).value;
			AbstractSymbol s = (AbstractSymbol) ((java_cup.runtime.Symbol) CUP$ASTParser$stack
					.elementAt(CUP$ASTParser$top - 0)).value;
			curr_lineno = l;
		...
		case 38: // expr_aux ::= LINENO INT INT_CONST
		{
			...
			Integer l = (Integer) ((java_cup.runtime.Symbol) CUP$ASTParser$stack
					.elementAt(CUP$ASTParser$top - 2)).value;
			AbstractSymbol i = (AbstractSymbol) ((java_cup.runtime.Symbol) CUP$ASTParser$stack
					.elementAt(CUP$ASTParser$top - 0)).value;
			curr_lineno = l;
		...
		case 36: // expr_aux ::= LINENO LEQ expr expr
		{
			Expression RESULT = null;
			Integer l = (Integer) ((java_cup.runtime.Symbol) CUP$ASTParser$stack
					.elementAt(CUP$ASTParser$top - 3)).value;
			Expression e1 = (Expression) ((java_cup.runtime.Symbol) CUP$ASTParser$stack
					.elementAt(CUP$ASTParser$top - 1)).value;
			Expression e2 = (Expression) ((java_cup.runtime.Symbol) CUP$ASTParser$stack
					.elementAt(CUP$ASTParser$top - 0)).value;
			curr_lineno = l;
		...
		case 25: // expr_aux ::= LINENO LET ID ID expr expr
		{
			Expression RESULT = null;
			Integer l = (Integer) ((java_cup.runtime.Symbol) CUP$ASTParser$stack
					.elementAt(CUP$ASTParser$top - 5)).value;
			AbstractSymbol n = (AbstractSymbol) ((java_cup.runtime.Symbol) CUP$ASTParser$stack
					.elementAt(CUP$ASTParser$top - 3)).value;
			AbstractSymbol t = (AbstractSymbol) ((java_cup.runtime.Symbol) CUP$ASTParser$stack
					.elementAt(CUP$ASTParser$top - 2)).value;
			Expression i = (Expression) ((java_cup.runtime.Symbol) CUP$ASTParser$stack
					.elementAt(CUP$ASTParser$top - 1)).value;
			Expression b = (Expression) ((java_cup.runtime.Symbol) CUP$ASTParser$stack
					.elementAt(CUP$ASTParser$top - 0)).value;
			curr_lineno = l;
		...
		case 23: // expr_aux ::= LINENO LOOP expr expr
		{
			...
			Integer l = (Integer) ((java_cup.runtime.Symbol) CUP$ASTParser$stack
					.elementAt(CUP$ASTParser$top - 3)).value;
			Expression p = (Expression) ((java_cup.runtime.Symbol) CUP$ASTParser$stack
					.elementAt(CUP$ASTParser$top - 1)).value;
			Expression b = (Expression) ((java_cup.runtime.Symbol) CUP$ASTParser$stack
					.elementAt(CUP$ASTParser$top - 0)).value;
			curr_lineno = l;
		...
		case 22: // expr_aux ::= LINENO COND expr expr expr
		{
			...
			Expression p = (Expression) ((java_cup.runtime.Symbol) CUP$ASTParser$stack
					.elementAt(CUP$ASTParser$top - 2)).value;
			Expression t = (Expression) ((java_cup.runtime.Symbol) CUP$ASTParser$stack
					.elementAt(CUP$ASTParser$top - 1)).value;
			Expression e = (Expression) ((java_cup.runtime.Symbol) CUP$ASTParser$stack
					.elementAt(CUP$ASTParser$top - 0)).value;
			curr_lineno = l;
		...
		case 21: // expr_aux ::= LINENO DISPATCH expr ID actuals
		{
			...
			AbstractSymbol n = (AbstractSymbol) ((java_cup.runtime.Symbol) CUP$ASTParser$stack
					.elementAt(CUP$ASTParser$top - 1)).value;
			Expressions a = (Expressions) ((java_cup.runtime.Symbol) CUP$ASTParser$stack
					.elementAt(CUP$ASTParser$top - 0)).value;
			curr_lineno = l;
		...
		case 18: // expr ::= expr_aux COLON NO_TYPE
		{
			...
			Expression e = (Expression) ((java_cup.runtime.Symbol) CUP$ASTParser$stack
					.elementAt(CUP$ASTParser$top - 2)).value;
			RESULT = e;
			CUP$ASTParser$result = new java_cup.runtime.Symbol(11/* expr */,
					RESULT);
		}
			return CUP$ASTParser$result;
		...
		case 16: // formal ::= LINENO FORMAL ID ID
		{
			...
			CUP$ASTParser$result = new java_cup.runtime.Symbol(9/* formal */,
					RESULT);
		}
			return CUP$ASTParser$result;
		...
		{
			Formals RESULT = null;
			Formals fl = (Formals) ((java_cup.runtime.Symbol) CUP$ASTParser$stack
					.elementAt(CUP$ASTParser$top - 1)).value;
			Formal f = (Formal) ((java_cup.runtime.Symbol) CUP$ASTParser$stack
					.elementAt(CUP$ASTParser$top - 0)).value;
		...
		case 13: // formals ::= formal_list
		{
			...
			Formals fl = (Formals) ((java_cup.runtime.Symbol) CUP$ASTParser$stack
					.elementAt(CUP$ASTParser$top - 0)).value;
			RESULT = fl;
			CUP$ASTParser$result = new java_cup.runtime.Symbol(7/* formals */,
					RESULT);
		}
			return CUP$ASTParser$result;
		...
		case 11: // feature ::= LINENO ATTR ID ID expr
		{
			...
			CUP$ASTParser$result = new java_cup.runtime.Symbol(6/* feature */,
					RESULT);
		}
			return CUP$ASTParser$result;
		...
		case 10: // feature ::= LINENO METHOD ID formals ID expr
		{
			...
			AbstractSymbol n = (AbstractSymbol) ((java_cup.runtime.Symbol) CUP$ASTParser$stack
					.elementAt(CUP$ASTParser$top - 3)).value;
			Formals f = (Formals) ((java_cup.runtime.Symbol) CUP$ASTParser$stack
					.elementAt(CUP$ASTParser$top - 2)).value;
			AbstractSymbol t = (AbstractSymbol) ((java_cup.runtime.Symbol) CUP$ASTParser$stack
					.elementAt(CUP$ASTParser$top - 1)).value;
			Expression b = (Expression) ((java_cup.runtime.Symbol) CUP$ASTParser$stack
		...
		case 9: // feature_list ::= feature_list feature
		{
			...
			Features fl = (Features) ((java_cup.runtime.Symbol) CUP$ASTParser$stack
					.elementAt(CUP$ASTParser$top - 1)).value;
			Feature f = (Feature) ((java_cup.runtime.Symbol) CUP$ASTParser$stack
					.elementAt(CUP$ASTParser$top - 0)).value;
			RESULT = fl.appendElement(f);
			CUP$ASTParser$result = new java_cup.runtime.Symbol(
				...
				// optional_feature_list RPAREN
		{
			class_ RESULT = null;
			Integer l = (Integer) ((java_cup.runtime.Symbol) CUP$ASTParser$stack
					.elementAt(CUP$ASTParser$top - 7)).value;
			AbstractSymbol n = (AbstractSymbol) ((java_cup.runtime.Symbol) CUP$ASTParser$stack
					.elementAt(CUP$ASTParser$top - 5)).value;
			AbstractSymbol p = (AbstractSymbol) ((java_cup.runtime.Symbol) CUP$ASTParser$stack
					.elementAt(CUP$ASTParser$top - 4)).value;
			AbstractSymbol file = (AbstractSymbol) ((java_cup.runtime.Symbol) CUP$ASTParser$stack
					.elementAt(CUP$ASTParser$top - 3)).value;
			Features f = (Features) ((java_cup.runtime.Symbol) CUP$ASTParser$stack
					.elementAt(CUP$ASTParser$top - 1)).value;
			curr_lineno = l;
			RESULT = new class_(l.intValue(), n, p, f, file);
			CUP$ASTParser$result = new java_cup.runtime.Symbol(3/* class */,
					RESULT);
		}
			return CUP$ASTParser$result;
		...
		{
			Classes RESULT = null;
			Classes cl = (Classes) ((java_cup.runtime.Symbol) CUP$ASTParser$stack
					.elementAt(CUP$ASTParser$top - 1)).value;
			class_ c = (class_) ((java_cup.runtime.Symbol) CUP$ASTParser$stack
					.elementAt(CUP$ASTParser$top - 0)).value;
			RESULT = cl.appendElement(c);
			CUP$ASTParser$result = new java_cup.runtime.Symbol(
					2/* class_list */, RESULT);
		...
		case 2: // program ::=
		{
			...
			RESULT = null;
			System.exit(1);
			CUP$ASTParser$result = new java_cup.runtime.Symbol(1/* program */,
					RESULT);
		}
			return CUP$ASTParser$result;
		...
		{
			Object RESULT = null;
			program start_val = (program) ((java_cup.runtime.Symbol) CUP$ASTParser$stack
					.elementAt(CUP$ASTParser$top - 1)).value;
			RESULT = start_val;
			CUP$ASTParser$result = new java_cup.runtime.Symbol(0/* $START */,
					RESULT);
		}
			/* ACCEPT */
