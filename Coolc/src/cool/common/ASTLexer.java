...
public class ASTLexer implements java_cup.runtime.Scanner
{
		...
		while (true)
		{
			...
			else
			{
				...
				else
				{
					...
					case 9:
					{
						return new Symbol(ASTConstants.LINENO, new Integer(
								yytext().substring(1)));
					}
					case -10:
						break;
					...
					case 42:
					{
						...
						return new Symbol(ASTConstants.STR_CONST,
								AbstractTable.stringtable.addString(buf
										.toString()));
					}
					case -43:
						break;
					...
					case 48:
					{
						buf.append((char) Integer.parseInt(yytext()
								.substring(2), 16));
					}
					case -49:
						break;
